...
- **Mermaid Diagrams**: Fenced `mermaid` code blocks are rendered as diagrams (flowchart, sequence, class, state, ER, gantt, pie, mindmap) when using the Node.js API or CLI
