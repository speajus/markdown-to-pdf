...
export async function renderMarkdownToPdf(
  ...
  // In browser, renderImage must be provided
  if (!options?.renderImage) {
    throw new Error('renderImage option is required in browser environment. Use createBrowserImageRenderer().');
  }

  const imageRenderer = options.renderImage;
